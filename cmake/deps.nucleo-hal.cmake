...
if(TOOLCHAIN_VARIANT STREQUAL "gnuarm14.3")
    ...
    set(HAL753_PACKAGE_URL
        "file://${CMAKE_CURRENT_SOURCE_DIR}/../hal753/build/nucleo-h753-hal-local-gnuarm14.3/nucleo-hal-${HAL753_PACKAGE_VERSION}-gnuarm14.3.tar.gz"
    )
    # Skip checksum for local package
    set(HAL753_PACKAGE_SHA256 "")
elseif(TOOLCHAIN_VARIANT STREQUAL "atfe21.1")
    set(HAL753_PACKAGE_URL
        "https://github.com/sohal/hal753/releases/download/${GITHUB_BRANCH_hal753}/nucleo-hal-${HAL753_PACKAGE_VERSION}-atfe21.1.tar.gz"
    )

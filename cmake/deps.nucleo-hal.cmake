...
if(NOT DEFINED GITHUB_BRANCH_hal753)
    set(GITHUB_BRANCH_hal753 "v1.0.1" CACHE STRING "hal753 release version")
endif()

# Derive HAL753_VERSION from GITHUB_BRANCH_hal753 (strip 'v' prefix)
# Expected format: vX.Y.Z -> X.Y.Z
string(REGEX REPLACE "^v" "" HAL753_VERSION "${GITHUB_BRANCH_hal753}")
set(HAL753_VERSION "${HAL753_VERSION}" CACHE STRING "hal753 package version" FORCE)

# Select package URL and checksum based on toolchain
if(TOOLCHAIN_VARIANT STREQUAL "gnuarm14.3")
    set(HAL753_PACKAGE_URL "https://github.com/sohal/hal753/releases/download/${GITHUB_BRANCH_hal753}/nucleo-hal-${HAL753_VERSION}-gnuarm14.3.tar.gz")
...
elseif(TOOLCHAIN_VARIANT STREQUAL "atfe21.1")
    set(HAL753_PACKAGE_URL "https://github.com/sohal/hal753/releases/download/${GITHUB_BRANCH_hal753}/nucleo-hal-${HAL753_VERSION}-atfe21.1.tar.gz")
